module Wice
  module Controller
    ...
    #
    # Option +erb_mode+ defines the style of the view helper, +false+ for the standard view helper (the default), and +true+
    # for the <tt>ERB mode</tt>. Please read the documentation for the +grid+ helper for details.
    #
